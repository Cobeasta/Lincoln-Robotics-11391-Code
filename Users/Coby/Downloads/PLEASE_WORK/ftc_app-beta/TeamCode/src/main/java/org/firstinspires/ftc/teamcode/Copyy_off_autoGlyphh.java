 ...
 */
@Autonomous(name = "autonomous glyph2", group = "concept")
public class Copyy_off_autoGlyphh extends LinearOpMode {
    int position;
...
//        }
//        runtime.reset();
//        while(opModeIsActive() &&runtime.seconds() < .35 && !isStopRequested()){
...
//        robot.rightMotor.setPower(0);
        ...
        /**
         * See if any of e instances of {@link relicTemplate} are currently visible.
